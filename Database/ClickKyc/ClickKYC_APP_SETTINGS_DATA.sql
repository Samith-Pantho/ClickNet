...
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('JWT_SECRET_KEY', 'JWT signing key', '3', '#$HGJ£GFFHJ@BH€JO6KJ5445LK#5J145H4KJK$KS£SKJ');
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('DIDIT_WORKFLOW_ID', 'Didit Workflow ID for Custom EKYC', '3', '128e04da-3e71-4668-84fa-9f504223ecd1');
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('DIDIT_API_KEY', 'Didit API Key', '3', '0az5jaYNPupS-1QDxPdec3W66eD1GAJOvW0z8sMnTo8');
...
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('DIDIT_WEBHOOK_SECRET', 'Didit webhook secret key for checking signature', '3', 'bViz90APhECcAqfdSQlGZ88bwdID5RHcxmkFdLn5qW0');
...
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('ENCRYPTION_FIXED_KEY', 'Fixed key for encryption', '3', 'NI4XNJKHL54D6D4BF66SOFA5DDFNA5ASDSKZKP56KDFFDIJS4L4OLFÖCL5JVSGJ6');
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('DIDIT_WEBHOOK_KEY', 'KYC Webhook Key', '3', 'ruCNlEjqZdk3TaB5RdJ7dJaWZ2r3dpGGVER9sqNXucsnBD6tnT63Ek7b4Ft9kRrT');
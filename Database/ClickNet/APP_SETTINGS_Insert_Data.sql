...
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('CLICKNET_SENDER_EMAIL', 'Sender email for ClickNet', '3', 'serviceclicknet@gmail.com');
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('CLICKNET_SENDER_EMAIL_PASS', 'Sender email password', '3', 'myyjwzttpgowxhni');
...
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('ENCRYPTION_FIXED_KEY', 'Fixed key for encryption', '3', 'OIPDJFS654OISÖGJDFLXZDNVC654DSFLK65A4ADSLK564SADLJKFFNHN564BJKDF');
...
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('JWT_SECRET_KEY', 'JWT signing key', '3', '#$GJHFGJHF£@LJKHOBJK€56445#JKHJK15454$£JSKSK');
...
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('TWILIO_ACCOUNT_SID', 'Twilio account SID', '3', 'AC03577a184cd16de28abdc11e18f22b7f');
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('TWILIO_AUTH_TOKEN', 'Twilio auth token', '3', '8fbf030af3f4a862af502f07412125cc');
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('TWILIO_MOBILE_NUMBER', 'Twilio sender number', '3', '+14155238886');
...
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('OPENAI_API_KEY', 'OpenAI Api SecretKey', '3', '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');
...
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('FERNET_SECRET_KEY', 'Fernet SecretKey for image encryption', '3', '8TYJkn0fFDGDRR_UjkC_PzEOD7MCavXxiDLk1j_Q-BA=');
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('GOOGLE_RECAPTCHA_SITE_KEY', 'Google reCAPTCHA site key', '2', '6LevlZorAAAAAALQXGQvyrfumXAyOFMhdj-aF-pU');
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('GOOGLE_RECAPTCHA_SECRET_KEY', 'Google reCAPTCHA secret key', '3', '6LevlZorAAAAAHg9HGammc-bm2YBdyactAFnovnp');
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('ORS_API_KEY', 'OpenStreetMap API key', '2', 'eyJvcmciOiI1YjNjZTM1OTc4NTExMTAwMDFjZjYyNDgiLCJpZCI6IjQ3MWQ0YmM2ZmE3MTQwNjdiMWU4MWNlMmM4Zjc0YmUwIiwiaCI6Im11cm11cjY0In0=');
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('STRIPE_SECRET_KEY', 'Stripe API secret key', '3', 'sk_test_51Rv2YeByxdf5qAg7aAv7zndaduNtdCG8dQ8GlkKsp1FiFLuBvBEqQA0eaEwGOBfkMhc1Vn80eUKrCE48zXiCb02W00M9JFCx4X');
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('STRIPE_PUBLISHABLE_KEY', 'Stripe publishable key for websit', '2', 'pk_test_51Rv2YeByxdf5qAg7gLEoldqeWUxaa1PaIa10itXZVB3USyFLYDSZx1u6TVd8Zg4t9EKEljWZcvKVrxjbdjzQAR2z00xUFQ9OzF');
...
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('STRIPE_WEBHOOK_SECRET', 'Stripe secret key for webhook', '3', 'whsec_Cx7QmDoJfZqiFECgjTj7oKGfeymcEuJZ');
INSERT INTO APP_SETTINGS (`KEY`, DESCRIPTION, PRIVACYLEVEL, VALUE) VALUES ('API_WEBHOOK_KEY', 'Secret key for API webhook', '3', 'Z9QsmfWsDYosGxsWf2YRYo7ZtgZbC6jkSCekfpJaAKbju8yKF1q71US7CsNy12Jq');
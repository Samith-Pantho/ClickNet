...
const ForgotUserIdForm = forwardRef(({ onSubmit, isLoading, onChange }, ref) => {
    ...
    <div className="auth-container auth-overlay" style={{ 
      ...
      <div className="auth-form-wrapper">
        <div className="logo-title-container">
          ...
          <h3 className="auth-title">Recover UserId</h3>
        </div>
        <form onSubmit={handleSubmit} className="auth-form">
          <div className="form-row">
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleChange}
                required={config.TAXID_MENDATORY_AT_FORGET_USERID?.toLowerCase() === 'true'}
              />
            </div>
          </div>
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleChange}
                required={config.DOB_VERIFICATION_MENDATORY_AT_FORGET_USERID?.toLowerCase() === 'true'}
              />
            </div>
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleChange}
                required={config.MOBILE_MENDATORY_AT_FORGET_USERID?.toLowerCase() === 'true'}
              />
            </div>
          </div>
          ...
          <div className="form-actions">
            <button type="submit" className="button button-primary" disabled={isLoading}>
              {isLoading ? 'Recovering...' : 'Recover User ID'}
            </button>
